...
class LMMD_loss(nn.Module):
    ...
    def convert_to_onehot(self, sca_label, class_num=3):
        return np.eye(class_num)[sca_label.astype(int)]
    #[1,0,0]
    #[0,1,0]

    def cal_weight(self, s_label, t_label, batch_size=32141, class_num=3):
        #print(s_label)
        #print(t_label)
        batch_size = s_label.size()[0]
        #batch_size = 1 # TODO use batch
